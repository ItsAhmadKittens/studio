// This file implements the Genkit flow for translating text from a detected source language to a user-specified target language.

'use server';

/**
 * @fileOverview Text translation flow using Genkit.
 *
